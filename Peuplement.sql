...
--
insert into Alizon._Produit(ID_Categorie,libelle,descr,sponsorise,prix_HT,code_taxe,quantite_stock,masquer) values (1,'Produit 1','Description du produit 1',true,10.0,'T10',10,false);
insert into Alizon._Produit(ID_Categorie,libelle,descr,sponsorise,prix_HT,code_taxe,quantite_stock,masquer) values (1,'Produit 2','Description du produit 2',false,20.0,'T5',20,false);
insert into Alizon._Produit(ID_Categorie,libelle,descr,sponsorise,prix_HT,code_taxe,quantite_stock,masquer) values (1,'Produit 3','Description du produit 3',true,30.0,'T20',30,false);
insert into Alizon._Produit(ID_Categorie,libelle,descr,sponsorise,prix_HT,code_taxe,quantite_stock,masquer) values (1,'Produit 4','Description du produit 4',true,30.0,'T20',30,false);
insert into Alizon._Produit(ID_Categorie,libelle,descr,sponsorise,prix_HT,code_taxe,quantite_stock,masquer) values (1,'Produit 5','Description du produit 5',true,30.0,'T20',30,false);
insert into Alizon._Produit(ID_Categorie,libelle,descr,sponsorise,prix_HT,code_taxe,quantite_stock,masquer) values (1,'Produit 6','Description du produit 6',true,30.0,'T20',30,false);
insert into Alizon._Produit(ID_Categorie,libelle,descr,sponsorise,prix_HT,code_taxe,quantite_stock,masquer) values (1,'Produit 7','Description du produit 7',true,30.0,'T20',30,false);
insert into Alizon._Produit(ID_Categorie,libelle,descr,sponsorise,prix_HT,code_taxe,quantite_stock,masquer) values (1,'Produit 8','Description du produit 8',true,30.0,'T20',30,false);
insert into Alizon._Produit(ID_Categorie,libelle,descr,sponsorise,prix_HT,code_taxe,quantite_stock,masquer) values (1,'Produit 9','Description du produit 9',true,30.0,'T20',30,false);
