                ...
                <h3>Inscrivez-vous:</h3>
                    ...
                    <form id="Formid" action="./inscription_sql.php" method="post">
                        ...
                        <div class="row justify-content-center mt-3">
                            ...
                            <p class="multiline">Alizon traite les données receuillies à des fins de gestion de la relation client, gestion des commande et des livraisons, pour en savoir plus, veuilez consulter nos <a href="./cgu_cgv.php" id="cgu">CGU/CGV </a></p>
                            </div>
                        </div>
                    </form>
                    <div class="row justify-content-center mt-3">
