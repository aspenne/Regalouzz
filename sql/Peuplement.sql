...
insert into Alizon._Produit(ID_Categorie,libelle,descr,sponsorise,prix_HT,code_taxe,quantite_stock,masquer,id_vendeur) values (1,'Crêpes au Nutella','Les crépes bretonnes font entiérement partie de l''histoire de la bretagne, a déguster salé ou sucré, elles restent incontournable. Elles sont faite a base de farine, oeuf, sucre et beure, et conféctionné dans un bilig.',true,30.0,'T20',30,false,1);
insert into Alizon._Produit(ID_Categorie,libelle,descr,sponsorise,prix_HT,code_taxe,quantite_stock,masquer,id_vendeur) values (1,'Crêpes au Sucre','Les crépes bretonnes font entiérement partie de l''histoire de la bretagne, a déguster salé ou sucré, elles restent incontournable. Elles sont faite a base de farine, oeuf, sucre et beure, et conféctionné dans un bilig.',true,30.0,'T20',30,false,1);
